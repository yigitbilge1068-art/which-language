...
if ../minilibrary init 2>&1 | grep -q "Initialized empty mini-library" && [ -d .minilibrary ] && [ -f .minilibrary/books.dat ]; then
  pass "init creates .minilibrary directory and books.dat"
else
  fail "init creates .minilibrary directory and books.dat"
fi
